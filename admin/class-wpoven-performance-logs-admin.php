...
class Wpoven_Performance_Logs_Admin
{
	...
	public function __construct($plugin_name, $version)
	{
		...
		if (!class_exists('ReduxFramework') && file_exists(include_once WPOVEN_PERFORMANCE_PATH . 'framework/redux-framework/redux-core/framework.php')) {
			include_once WPOVEN_PERFORMANCE_PATH . 'framework/redux-framework/redux-core/framework.php';
		}
