...
$args = array(
	...
	'menu_title'                => esc_html__( 'Sample Options', 'wpoven-performance-logs' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sample Options', 'wpoven-performance-logs' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'wpoven-performance-logs' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'wpoven-performance-logs' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'wpoven-performance-logs' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'wpoven-performance-logs' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'wpoven-performance-logs' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'wpoven-performance-logs' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'wpoven-performance-logs' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'wpoven-performance-logs' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'wpoven-performance-logs' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'wpoven-performance-logs' ) . '</p>';
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'wpoven-performance-logs' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Editors', 'wpoven-performance-logs' ),
		'id'               => 'editor',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Color Selection', 'wpoven-performance-logs' ),
		'id'    => 'color',
		'icon'  => 'el el-brush',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Design Fields', 'wpoven-performance-logs' ),
		'id'    => 'design',
		'icon'  => 'el el-wrench',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Media Uploads', 'wpoven-performance-logs' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Presentation Fields', 'wpoven-performance-logs' ),
		'id'    => 'presentation',
		'icon'  => 'el el-screen',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Switch / Button Set', 'wpoven-performance-logs' ),
		'id'    => 'switch_buttonset',
		'icon'  => 'el el-cogs',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Select Fields', 'wpoven-performance-logs' ),
		'id'    => 'select',
		'icon'  => 'el el-list-alt',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Slider / Spinner', 'wpoven-performance-logs' ),
		'id'    => 'slider_spinner',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Additional Types', 'wpoven-performance-logs' ),
		'id'    => 'additional',
		'icon'  => 'el el-magic',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Advanced Features', 'wpoven-performance-logs' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Disabling', 'wpoven-performance-logs' ),
		'icon'  => 'el el-lock',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Redux Extensions', 'wpoven-performance-logs' ),
		'id'    => 'redux-extensions',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'wpoven-performance-logs' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
	)
);
...
if ( file_exists( $dir . '/../README.md' ) ) {
	$section = array(
		'icon'   => 'el el-list-alt',
		'title'  => esc_html__( 'Documentation', 'wpoven-performance-logs' ),
		'fields' => array(
			array(
...
Redux::set_section(
	...
	array(
		'icon'            => 'el el-list-alt',
		'title'           => esc_html__( 'Customizer Only', 'wpoven-performance-logs' ),
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'wpoven-performance-logs' ) . '</p>',
		'customizer_only' => true,
		'fields'          => array(
			array(
				'id'              => 'opt-customizer-only',
				'type'            => 'select',
				'title'           => esc_html__( 'Customizer Only Option', 'wpoven-performance-logs' ),
				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'wpoven-performance-logs' ),
				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'wpoven-performance-logs' ),
				'customizer_only' => true,
				'options'         => array(
					'1' => esc_html__( 'Opt 1', 'wpoven-performance-logs' ),
					'2' => esc_html__( 'Opt 2', 'wpoven-performance-logs' ),
					'3' => esc_html__( 'Opt 3', 'wpoven-performance-logs' ),
				),
				'default'         => '2',
			),
		),
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'wpoven-performance-logs' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'wpoven-performance-logs' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'wpoven-performance-logs' );
