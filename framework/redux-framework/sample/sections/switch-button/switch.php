...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Switch', 'wpoven-performance-logs' ),
		'id'         => 'switch_buttonset-switch',
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'wpoven-performance-logs' ) . '<a href="https://devs.redux.io/core-fields/switch.html" target="_blank">https://devs.redux.io/core-fields/switch.html</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'       => 'switch-on',
			...
			array(
				'id'       => 'switch-off',
				'type'     => 'switch',
				'title'    => esc_html__( 'Switch Off', 'wpoven-performance-logs' ),
				'subtitle' => esc_html__( 'Look, it\'s on!', 'wpoven-performance-logs' ),
				'default'  => false,
			),
			array(
			...
			array(
				...
				'type'     => 'switch',
				'required' => array( 'switch-parent', '=', true ),
				'title'    => esc_html__( 'Switch2 - Enable the above switch and this one for patterns to show', 'wpoven-performance-logs' ),
				'subtitle' => esc_html__( 'Also called a "fold" parent.', 'wpoven-performance-logs' ),
				'desc'     => esc_html__( 'Items set with a fold to this ID will hide unless this is set to the appropriate value.', 'wpoven-performance-logs' ),
				'default'  => false,
			),
