...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Icon Select', 'wpoven-performance-logs' ),
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'wpoven-performance-logs' ) . '<a href="https://devs.redux.io/core-extensions/icon-select.html" target="_blank">https://devs.redux.io/core-extensions/icon-select.html</a>',
		'subsection' => true,
		'fields'     => array(
			...
			array(
				...
				'type'             => 'icon_select',
				'title'            => esc_html__( 'Legacy Icon Select', 'wpoven-performance-logs' ),
				'subtitle'         => esc_html__( 'Original Icon Select field that maintains backward compatibility with the original extension.', 'wpoven-performance-logs' ),
				'default'          => '',
			...
			array(
				...
				'type'             => 'icon_select',
				'title'            => esc_html__( 'Icon Select', 'wpoven-performance-logs' ),
				'subtitle'         => esc_html__( 'Select an icon.', 'wpoven-performance-logs' ),
				'default'          => 'fas fa-1',
