...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Tabbed', 'wpoven-performance-logs' ),
		'id'         => 'additional-tabbed',
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'wpoven-performance-logs' ) . '<a href="https://devs.redux.io/core-fields/tabbed.html" target="_blank">https://devs.redux.io/core-fields/tabbed.html</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'    => 'opt-tabbed-1',
				...
				'tabs'  => array(
					...
					array(
						'title'  => esc_html__( 'Color Fields', 'wpoven-performance-logs' ),
						'icon'   => 'fas fa-palette',
						'fields' => array(
							array(
								'id'    => 'opt-tab-color-1',
								'type'  => 'color',
								'title' => esc_html__( 'Color 1', 'wpoven-performance-logs' ),
							),
							array(
								'id'    => 'opt-tab-color-2',
								'type'  => 'color',
								'title' => esc_html__( 'Color 2', 'wpoven-performance-logs' ),
							),
						),
					),
				),
			...
			array(
				...
				'tabs'  => array(
					...
					array(
						...
						'fields' => array(
							array(
								'title' => esc_html__( 'WP Editor', 'wpoven-performance-logs' ),
								'id'    => 'opt-tab-editor',
								'type'  => 'editor',
							),
							array(
