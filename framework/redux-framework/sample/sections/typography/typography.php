...
Redux::set_section(
	$opt_name,
	array(
		'title'  => esc_html__( 'Typography', 'wpoven-performance-logs' ),
		'id'     => 'typography',
		'desc'   => esc_html__( 'For full documentation on this field, visit: ', 'wpoven-performance-logs' ) . '<a href="https://devs.redux.io/core-fields/typography.html" target="_blank">https://devs.redux.io/core-fields/typography.html</a>',
		'icon'   => 'el el-font',
		'fields' => array(
			array(
				'id'                => 'opt-typography-body',
				'type'              => 'typography',
				'title'             => esc_html__( 'Body Font', 'wpoven-performance-logs' ),
				'subtitle'          => esc_html__( 'Specify the body font properties.', 'wpoven-performance-logs' ),
				'google'            => true,
			...
			array(
				'id'          => 'opt-typography',
				'type'        => 'typography',
				'title'       => esc_html__( 'Typography Site Description', 'wpoven-performance-logs' ),
				...
				'all-subsets' => true,
				'units'       => 'px',
				'subtitle'    => esc_html__( 'Typography option with each property can be called individually.', 'wpoven-performance-logs' ),
				'default'     => array(
					'color'       => '#333',
					'font-style'  => '700',
					'font-family' => 'Abel',
			...
			array(
				...
				'type'              => 'typography',
				'title'             => esc_html__( 'Title Font', 'wpoven-performance-logs' ),
				'subtitle'          => esc_html__( 'Specify the body font properties.', 'wpoven-performance-logs' ),
				'google'            => true,
				'font_family_clear' => false,
				'text-shadow'       => true,
