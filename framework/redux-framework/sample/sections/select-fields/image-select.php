...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Image Select', 'wpoven-performance-logs' ),
		'id'         => 'select-image_select',
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'wpoven-performance-logs' ) . '<a href="https://devs.redux.io/core-fields/image-select.html" target="_blank">https://devs.redux.io/core-fields/image-select.html</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'       => 'opt-image-select-layout',
				'type'     => 'image_select',
				'title'    => esc_html__( 'Images Option for Layout', 'wpoven-performance-logs' ),
				'subtitle' => esc_html__( 'No validation can be done on this field type', 'wpoven-performance-logs' ),
				'desc'     => esc_html__( 'This uses some of the built in images, you can use them for layout options.', 'wpoven-performance-logs' ),
			...
			array(
				...
				'type'     => 'image_select',
				'tiles'    => true,
				'title'    => esc_html__( 'Images Option (with tiles => true)', 'wpoven-performance-logs' ),
				'subtitle' => esc_html__( 'Select a background pattern.', 'wpoven-performance-logs' ),
				'default'  => 0,
			...
			array(
				'id'       => 'opt-image-select',
				'type'     => 'image_select',
				'title'    => esc_html__( 'Images Option', 'wpoven-performance-logs' ),
				'subtitle' => esc_html__( 'No validation can be done on this field type', 'wpoven-performance-logs' ),
