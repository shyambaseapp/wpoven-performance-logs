				...
				<div id="redux-add-widget" class="widgets-holder-wrap">
					<div class="">
						...
						<div class="sidebar-name">
							<h3><?php echo esc_html__( 'Create Widget Area', 'wpoven-performance-logs' ); ?> <span class="spinner"></span></h3>
						</div>
							...
							<form id="addWidgetAreaForm" action="" method="post">
								...
								<div class="widget-content">
									<input
											...
											class="regular-text"
											title="<?php echo esc_attr__( 'Name', 'wpoven-performance-logs' ); ?>"
											placeholder="<?php echo esc_attr__( 'Name', 'wpoven-performance-logs' ); ?>"/>
								</div>
								<div class="widget-control-actions">
									<div class="aligncenter">
										<input
												...
												type="submit"
												value="<?php echo esc_attr__( 'Create Widget Area', 'wpoven-performance-logs' ); ?>"/>
									</div>
									<br class="clear">
								</div>
							</form>
		...
		public function enqueue() {
			...
			wp_localize_script(
				...
				array(
					...
					'delete'  => esc_html__( 'Delete', 'wpoven-performance-logs' ),
					'confirm' => esc_html__( 'Confirm', 'wpoven-performance-logs' ),
					'cancel'  => esc_html__( 'Cancel', 'wpoven-performance-logs' ),
				)
			);
		}
	}
