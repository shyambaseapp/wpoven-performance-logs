...
if ( ! class_exists( 'Redux_Datetime', false ) ) {
	...
	class Redux_Datetime extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $split ) {
				$date_placeholder = $this->field['placeholder']['date'] ?? __( 'Date', 'wpoven-performance-logs' );
				$time_placeholder = $this->field['placeholder']['time'] ?? __( 'Time', 'wpoven-performance-logs' );
			} else {
				$date_placeholder = $this->field['placeholder'] ?? __( 'Date / Time', 'wpoven-performance-logs' );
			}
