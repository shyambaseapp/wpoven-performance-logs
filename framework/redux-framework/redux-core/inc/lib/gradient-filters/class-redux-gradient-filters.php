	...
	class Redux_Gradient_Filters {
		...
		public static function render_select( array $data ): string {
			...
			if ( $field['gradient-type'] ) {
				...
				$output .= '<strong>' . esc_html__( 'Gradient Type ', 'wpoven-performance-logs' ) . '</strong>&nbsp;';
				$output .= '<select ';
				$output .= 'class="redux-gradient-select select2-container"';
				$output .= 'data-placeholder="' . esc_attr__( 'Type', 'wpoven-performance-logs' ) . '" ' . $select2_data . ' ';
				...
				$arr = array(
					esc_html__( 'linear', 'wpoven-performance-logs' ),
					esc_html__( 'radial', 'wpoven-performance-logs' ),
				);
		...
		public static function render_sliders( array $data ): string {
			...
			if ( $field['gradient-reach'] ) {
				...
				$output .= '<div class="label">' . esc_html__( 'From Reach ', 'wpoven-performance-logs' ) . ':  <strong>' . esc_html( $value['gradient-reach']['from'] ) . '%</strong></div>';
				$output .= '<div ';
				...
				$output .= 'data-label="' . esc_attr__( 'From Reach', 'wpoven-performance-logs' ) . '"';
				...
				$output .= '<div class="label">' . esc_html__( 'To Reach', 'wpoven-performance-logs' ) . ':  <strong>' . esc_html( $value['gradient-reach']['to'] ) . '%</strong></div>';
				$output .= '<div ';
				...
				$output .= 'data-step="1"';
				$output .= 'data-rtl="' . esc_attr( is_rtl() ) . '"';
				$output .= 'data-label="' . esc_attr__( 'To Reach', 'wpoven-performance-logs' ) . '"';
			...
			if ( $field['gradient-angle'] ) {
				...
				$output .= '<div class="label">' . esc_html__( 'Gradient Angle', 'wpoven-performance-logs' ) . ':  <strong>' . $value['gradient-angle'] . '&deg;</strong></div>';
				$output .= '<div ';
				...
				$output .= 'data-step="1"';
				$output .= 'data-rtl="' . esc_attr( is_rtl() ) . '"';
				$output .= 'data-label="' . esc_attr__( 'Gradient Angle', 'wpoven-performance-logs' ) . '"';
