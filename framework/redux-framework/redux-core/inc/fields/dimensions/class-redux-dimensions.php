		...
		public function render() {
			...
			if ( true === $this->field['width'] ) {
				...
				echo '<input
						...
						placeholder="' . esc_html__( 'Width', 'wpoven-performance-logs' ) . '"
			...
			if ( isset( $this->field['units'] ) && false !== $this->field['units'] ) {
				echo '<div
						...
						original-title="' . esc_html__( 'Units', 'wpoven-performance-logs' ) . '">';

				echo '<select
						data-id="' . esc_attr( $this->field['id'] ) . '"
						data-placeholder="' . esc_html__( 'Units', 'wpoven-performance-logs' ) . '"
