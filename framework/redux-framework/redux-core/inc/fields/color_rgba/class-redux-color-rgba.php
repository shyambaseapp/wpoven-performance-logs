	...
	class Redux_Color_Rgba extends Redux_Field {
		...
		public function set_defaults() {
			...
			$option_defaults = array(
				...
				'choose_text'            => esc_html__( 'Choose', 'wpoven-performance-logs' ),
				'cancel_text'            => esc_html__( 'Cancel', 'wpoven-performance-logs' ),
				'show_buttons'           => true,
				'input_text'             => esc_html__( 'Select Color', 'wpoven-performance-logs' ),
				'palette'                => null,
			);
