...
class Templates {
	...
	public function add_templates( array $post_templates ): array {
		$post_templates['redux-templates_contained']  = __( 'Redux Contained', 'wpoven-performance-logs' );
		$post_templates['redux-templates_full_width'] = __( 'Redux Full Width', 'wpoven-performance-logs' );
		$post_templates['redux-templates_canvas']     = __( 'Redux Canvas', 'wpoven-performance-logs' );
